...
class ConfigManager:
    ...
    def get_optimal_api_endpoint() -> str:
        ...
        for backup_endpoint in backup_endpoints:
            if backup_endpoint != default_endpoint and ConfigManager.test_api_connectivity(backup_endpoint):
...
def print_environment_info():
    ...
    print(f"环境变量HOSPITAL_API_ENDPOINT: {os.getenv('HOSPITAL_API_ENDPOINT', '未设置')}")
