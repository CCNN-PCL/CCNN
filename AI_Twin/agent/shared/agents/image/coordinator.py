        ...
        try:
            ...
            if self.smart_retrieval:
                ...
                if not retrieval_result.images:
                    return "⚠️ 没有找到与您的描述相关的医学影像，请先上传相关影像进行分析。"
        ...
        try:
            ...
            if specified_hospital:
                ...
                if not filtered_images:
                    return f"⚠️ 未找到指定医院 '{specified_hospital}' 的影像数据"
